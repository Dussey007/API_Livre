...
Avec Postgres en cours d'exécution, restaurez une base de données à l'aide du fichier plants_database.sql fourni. Depuis le dossier backend dans le terminal, exécutez :
```bash
